...
@implementation LoveDivinationCell
...
- (void)layoutSubviews
{
    ...
    _btnDetail.backgroundColor=[UIColor colorWithHexString:@"#d9709b"];
    [_btnDetail setTitleColor:[UIColor colorWithHexString:@"#FFFFFF"] forState:UIControlStateNormal];
    [_btnDetail setTitle:@"無料鑑定する" forState:UIControlStateNormal];//無料鑑定する
    //あなたの未来を鑑定しますで 今すぐ無料鑑定
